...
export function Terms() {
    ...
    const extraContent=
        <div>
            <p className="extra-content text-base p-20 text-justify">
    ...
    return(
        ...
        <div className=" bg-g-header p-3 top-10 flex justify-center items-center bg-fixed bg-center bg-cover bg-no-repeat ">
            <div className="h-full flex flex-col w-3/4 justify-center items-center text-white">
                <h1 className=" text-2xl text-center p-10 px-24">
                ...
                <p className=" text-base p-20 text-justify">
                ...
                <button className="read-more-link text-white bg-orange-500 hover:bg-orange-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={()=>{setReadMore(!readMore)}}>
                    <h2>{linkName}</h2>
                </button>
