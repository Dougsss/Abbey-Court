...
export function Lostfound() {
    return(
        <>
        <div className=" bg-g-header p-3 top-10 flex flex-col justify-center items-center bg-fixed bg-center bg-cover bg-no-repeat ">
            <div className="w-1/2 bg-slate-100 p-3 m-5 opacity-50 text-lg text-center">
