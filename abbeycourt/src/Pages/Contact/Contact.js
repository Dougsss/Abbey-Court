        ...
        <div className=" bg-g-header p-3 top-10 h-10 flex justify-center items-center bg-fixed bg-center bg-cover bg-no-repeat"/>
        	<div className=" p-5 flex items-center justify-center flex-col">
                ...
                <form className="justify-center w-2/4 itens-center">
                    ...
                    <div className="mb-6">
                        <label for="itenLost" className="block mb-2 text-sm font-medium text-orange-600">What item have you lost?</label>
                    ...
                    <div class="mb-6">
                        <label for="date" className="block mb-2 text-sm font-medium text-orange-600">When did you first notice the item was missing?</label>
                    ...
                    <div className="mb-6">
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-orange-600">Where do you remember last seeing it?</label>
                    ...
                    <div class="mb-6">
                        <label for="checkOut" className="block mb-2 text-sm font-medium text-orange-600">What date did you CHECK OUT of Abbey Court?</label>
                    ...
                    <div className="flex justify-center items-center mb-6">
                        ...
                        <label for="terms" className="ml-2 text-sm font-medium text-white">I agree with the </label>
                    </div>
